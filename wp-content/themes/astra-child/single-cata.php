...
$descripcion  = ps_extract_section_text($content_html, 'Descripción');
...
<main class="ps-wrap ps-single">
  ...
  <header class="ps-hero" aria-label="Cabecera del paseo">
    <div class="ps-hero__media" style="<?php echo $img_url ? 'background-image:url(' . esc_url($img_url) . ');' : ''; ?>">
      ...
      <?php endif; ?>
      <span class="ps-hero__badge">Catas de Vino · Sevilla</span>
    </div>
    ...
    <div class="ps-hero__content">
      ...
      <ul class="ps-pills" aria-label="Datos clave">
        <?php if ( ! empty($descripcion) ): ?><li class="ps-pill">⏱ <?php echo esc_html($descripcion); ?></li><?php endif; ?>
  ...
  <section class="ps-grid" aria-label="Contenido del paseo">
    ...
    <aside class="ps-card ps-card--aside" aria-label="Ficha rápida">
      <div class="ps-card__body">
        ...
        <dl class="ps-meta">
          <div class="ps-meta__row"><dt>Descripción</dt><dd><?php echo $descripcion ? esc_html($descripcion) : '—'; ?></dd></div>
